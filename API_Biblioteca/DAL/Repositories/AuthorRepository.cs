...
namespace API_Biblioteca.DAL.Repositories
{
    public class AuthorRepository : IRepository<Autor>
    {
        ...
        public async Task<IEnumerable<Autor>> GetAllAsync() => await _context.Autors.ToListAsync();
        public async Task<Autor> GetByIdAsync(int id) => await _context.Autors.FindAsync(id);
